                            ...
                            <form id="kt_modal_add_user_form" class="form" action="{{route('super.notification.edit')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" name="label" class="form-control form-control-solid mb-3 mb-lg-0" required placeholder="Label" value="{{$dt->label}}" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" name="short_message" class="form-control form-control-solid mb-3 mb-lg-0" required placeholder="Short Message" value="{{$dt->short_message}}" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="date" name="expire" class="form-control form-control-solid mb-3 mb-lg-0" value="{{$dt->expire}}" placeholder="Expiration" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <textarea type="datetime" name="body_message" class="form-control form-control-solid mb-3 mb-lg-0" required placeholder="Message">{{$dt->body_message}}</textarea>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                </div>
