        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user">
                    <i class="ki-outline ki-plus fs-2"></i>Add Category</button>
                <!--end::Add user-->
            </div>
            <!--end::Toolbar-->
            <!--begin::Group actions-->
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body px-5 my-7">
                            <!--begin::Form-->
                            <form id="kt_modal_add_user_form" method="post" class="form" action="{{route('super.bountyCategoryAdd')}}">
                                @csrf
                                <!--begin::Scroll-->
                ...
                <tr>
                    ...
                    <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                            ...
                            <div class="menu-item px-3">
                                <a href="{{ route('super.bountySubCategory', ['id'=>encrypt($dt->id)])}}" class="menu-link px-3">Sub Category</a>
                            </div>
                            <div class="menu-item px-3">
                                <a href="{{route('super.bountyReport', ['severity'=>'all', 'category'=>$dt->id])}}" class="menu-link px-3">Report</a>
                            </div>
                        </div>
                        <!--end::Menu-->
                    </td>
...
<div class="modal fade" id="kt_modal_add_user-{{$dt->id}}" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body px-5 my-7">
                <!--begin::Form-->
                <form id="kt_modal_add_user_form" method="post" class="form" action="{{route('super.bountyCategoryUpdate')}}">
                    @csrf
