                ...
                <div class="card card-xl-stretch mb-xl-10 theme-dark-bg-body" style="background-color: #F7D9E3">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-flex flex-column flex-grow-1">
                            <!--begin::Title-->
                            <a href="#" class="text-gray-900 text-hover-primary fw-bold fs-3">User</a>
                            <!--end::Title-->
                            <!--begin::Chart-->
                        ...
                        <div class="pt-5">
                            ...
                            <!--end::Symbol-->
                            <!--begin::Number-->
                            <span class="text-gray-900 fw-bold fs-3x me-2 lh-0">{{$usersCount}}</span>
                            <!--end::Number-->
                            <!--begin::Text-->
                ...
                <div class="card card-xxl-stretch mb-5 mb-xl-10 theme-dark-bg-body" style="background-color: #CBD4F4">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="d-flex flex-column mb-7">
                            <!--begin::Title-->
                            <a href="#" class="text-gray-900 text-hover-primary fw-bold fs-3">File Summary</a>
                            <!--end::Title-->
                        </div>
                        <!--end::Wrapper-->
                        <!--begin::Row-->
                        <div class="row g-0">
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center mb-9 ms-2">
                                    ...
                                    <!--begin::Title-->
                                    <div>
                                        <div class="fs-5 text-gray-900 fw-bold lh-1">{{$fileSizeSum}}</div>
                                        <div class="fs-7 text-gray-600 fw-bold">Volume</div>
                                    </div>
                                    <!--end::Title-->
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="d-flex align-items-center me-2">
                                    ...
                                    <!--begin::Title-->
                                    <div>
                                        <div class="fs-5 text-gray-900 fw-bold lh-1">{{$fileActiveCount}}</div>
                                        <div class="fs-7 text-gray-600 fw-bold">Active</div>
                                    </div>
                                    <!--end::Title-->
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="d-flex align-items-center ms-2">
                                    ...
                                    <!--begin::Title-->
                                    <div>
                                        <div class="fs-5 text-gray-900 fw-bold lh-1">{{$fileArchiveCount}}</div>
                                        <div class="fs-7 text-gray-600 fw-bold">Archive</div>
                                    </div>
                                    <!--end::Title-->
                                </div>
                            </div>
