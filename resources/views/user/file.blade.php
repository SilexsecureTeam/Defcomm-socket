                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="text-muted fw-bold">
                            ...
                            <span class="mx-3">|</span>{{$file->count()}} items
                        </div>
                    </div>
                    <!--end::Title-->
                </div>
            ...
            <div class="card-body pb-0">
                ...
                <div class="d-flex overflow-auto h-55px">
                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-semibold flex-nowrap">
                        <!--begin::Nav item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary me-6 {{ $option == 'mine' ? 'active' : ''}}" href="{{url('/user/file')}}">My Files</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary me-6 {{ $option == 'other' ? 'active' : ''}}" href="{{url('/user/file/other')}}">Other File</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary me-6 {{ $option == 'request' ? 'active' : ''}}" href="{{url('/user/file/request')}}">My File Requests</a>
                        </li>
                        <!--end::Nav item-->
                    </ul>
                </div>
                                ...
                                <td class="text-end" data-kt-filemanager-table="action_dropdown">
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <div class="ms-2" data-kt-filemanger-table="copy_link">
                                            <a href="{{route('user.file.view', ['id' => encrypt($dt->id)])}}" class="btn btn-sm btn-icon btn-light">
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">
                                                <div class="menu-item px-3">
                                                    <a href="{{route('user.file.share.user', ['id' => encrypt($dt->id)])}}" class="menu-link px-3">Share to users</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="{{route('user.file.access.user', ['id' => encrypt($dt->id)])}}" class="menu-link px-3" data-kt-filemanager-table="rename">User Access</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="{{route('user.file.access.log', ['id' => encrypt($dt->id)])}}" class="menu-link px-3" data-kt-filemanager-table="rename">Access Log</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                    ...
                    <table id="kt_file_manager_list" data-kt-filemanager-table="files" class="table align-middle table-row-dashed fs-6 gy-5">
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td>{{$dt->file->user->name}}</td>
                                <td>{{$dt->file->created_at}}</td>
                                @if($option == "request")
                                <td>{{$dt->user->name}}</td>
                                <td>{{$dt->created_at}}</td>
                                @endif
                                ...
                                <td>
                                    @if($option == "request")
                                    <a target="_blank" href="{{route('user.file.view', ['id' => encrypt($dt->file->id)])}}" class="btn btn-danger">Cancel</a>
                                    @else
                                    <a target="_blank" href="{{route('user.file.view', ['id' => encrypt($dt->file->id)])}}" class="btn btn-primary">View</a>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="{{route('user.file.share.user.request', ['id' => encrypt($dt->file->id)])}}" class="menu-link px-3 text-primary" data-kt-users-table-filter="delete_row">Request to share</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    @endif
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body px-5 my-7">
                            <!--begin::Form-->
                            <form id="kt_modal_add_user_form" class="form" action="{{route('user.file.upload')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <!--begin::Scroll-->
