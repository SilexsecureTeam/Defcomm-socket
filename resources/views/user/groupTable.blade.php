<div class="card mt-5" id="groupPending">
    <!--begin::Card header-->
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar">
            ...
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                <!--begin::Add user-->
                <h2>Pending Group Invitation</h2>
                <!--end::Add user-->
            </div>
            <!--end::Toolbar-->
        </div>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
            ...
            <tbody class="text-gray-600 fw-semibold">
                ...
                <tr>
                    ...
                    <td>{{$dt->created_at}}</td>
                    <td>
                        <a href="{{route('user.group.accept', ['id' => encrypt($dt->id)])}}" class="btn btn-primary">Accept</a>
                        <a href="{{route('user.group.decline', ['id' => encrypt($dt->id)])}}" class="btn btn-danger">Decline</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
