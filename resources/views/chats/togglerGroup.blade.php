<div class="tab-pane fade" id="kt_sidebar_tab_1" role="tabpanel" wire:ignore.self>
    ...
    <div class="card card-flush card-p-0 card-reset mb-5">
        ...
        <div class="card-header align-items-center border-0">
            <!--begin::Title-->
            <h3 class="card-title fw-bold text-white fs-3">Groups</h3>
            <!--end::Title-->
            <!--begin::Toolbar-->
        ...
        <div class="card-body py-0" id="kt_drawer_chat2_toggle">
            ...
            @forelse($group as $dt)
            <!--begin::Item-->
            <div wire:click="chat({{$dt->id}},'group')" onclick="forceScrollDownLcl()" class="d-flex flex-nowrap align-items-center mb-7" id="kt_drawer_chat_toggle">
                <!--begin::Image-->
            ...
            @forelse($group as $dt)
            <!--begin::Item-->
            <div wire:click="chat({{$dt->group_id}},'group')" onclick="forceScrollDownLcl()" class="d-flex flex-nowrap align-items-center mb-7" id="kt_drawer_chat_toggle">
                <!--begin::Image-->
                <a href="#" class="symbol symbol-40px symbol-2by3 me-4">
                    <img src="{{ $dt->companyGroup->avatar ? asset('/'.$dt->companyGroup->avatar) : asset('/img/user.png')}}" alt="" class="mw-100 object-fit-cover" />
                </a>
                <!--end::Image-->
                <!--begin::Title-->
                <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pe-3">
