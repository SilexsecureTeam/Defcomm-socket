        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div id="kt_aside" class="aside py-9" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
                ...
                <div class="aside-logo flex-column-auto px-9 mb-9" id="kt_aside_logo">
                    <!--begin::Logo-->
                    <a href="#">
                        <img alt="Logo" src="{{asset('img/icon.png')}}" class="h-60px rounded logo theme-light-show" />
                        <img alt="Logo" src="{{asset('img/icon.png')}}" class="h-60px rounded logo theme-dark-show" />
                    </a>
                    <!--end::Logo-->
                </div>
                <!--end::Brand-->
                    ...
                    <div class="container d-flex flex-stack flex-wrap gap-4" id="kt_header_container">
                        ...
                        <div class="d-flex align-items-center flex-shrink-0 mb-0 mb-lg-0">
                            ...
                            <div class="d-flex align-items-center d-xxl-none ms-3 ms-lg-4">
                                <div class="btn btn-icon btn-color-gray-700 btn-active-color-primary btn-outline w-40px h-40px position-relative" id="kt_drawer_chat2_toggle">
                ...
                <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                    ...
                    <div class="container d-flex flex-column flex-md-row flex-stack">
                        ...
                        <div class="text-gray-900 order-2 order-md-1">
                            ...
                            <a href="#" target="_blank" class="text-muted text-hover-primary fw-semibold me-2 fs-6">Silex Secure Lab</a>
                        </div>
                        <!--end::Copyright-->
                    </div>
                    <!--end::Container-->
